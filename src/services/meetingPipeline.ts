    ...
    try {
      ...
      */
      ...
      try {
        ...
        console.error(`❌ [MEETING PIPELINE] Error fetching user timezone:`, error);
      }
        ...
        if (meetingRequest) {
          ...
          try {
            if (!this.responseService) {
              console.warn('⚠️ [MEETING PIPELINE FALLBACK] ResponseService not available, skipping fallback draft');
            } else {
            ...
            console.error('❌ [MEETING PIPELINE FALLBACK] Failed to create fallback draft:', fallbackError);
